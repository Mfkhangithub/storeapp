...
import 'package:store_app/Functions/shoesfunctions.dart';
import 'package:store_app/Utils/utils.dart';
import 'package:store_app/View/SingInScreens/singin_screen.dart';

class ShoesProScreen extends StatefulWidget {
  const ShoesProScreen({super.key});

  @override
  State<ShoesProScreen> createState() => _ProductScreenState();
}

class _ProductScreenState extends State<ShoesProScreen> {
  ...
  final FirebaseServiceShoes firebaseService = FirebaseServiceShoes(); // Create an instance of FirebaseService
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Shoes Edit", style: TextStyle(color: Colors.white)),
