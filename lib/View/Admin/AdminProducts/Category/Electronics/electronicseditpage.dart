...
import 'package:store_app/Functions/electonicsfunction.dart';
import 'package:store_app/Utils/utils.dart';
import 'package:store_app/View/SingInScreens/singin_screen.dart';

class ElectronicsProScreen extends StatefulWidget {
  const ElectronicsProScreen({super.key});

  @override
  State<ElectronicsProScreen> createState() => _ProductScreenState();
}

class _ProductScreenState extends State<ElectronicsProScreen> {
  ...
  final FirebaseServiceElectronics firebaseService = FirebaseServiceElectronics(); // Create an instance of FirebaseService
  ...
  final fireStore = FirebaseFirestore.instance.collection("electronicsdata").snapshots();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Electronics Edit", style: TextStyle(color: Colors.white)),
