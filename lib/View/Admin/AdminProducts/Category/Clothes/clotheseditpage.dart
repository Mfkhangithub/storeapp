...
class ClothesProScreen extends StatefulWidget {
  const ClothesProScreen({super.key});

  @override
  State<ClothesProScreen> createState() => _ProductScreenState();
}

class _ProductScreenState extends State<ClothesProScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Clothes Edit", style: TextStyle(color: Colors.white)),
