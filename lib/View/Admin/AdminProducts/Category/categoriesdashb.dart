...
import 'package:store_app/View/Admin/AdminProducts/Category/Banner/banner.dart';
import 'package:store_app/View/Admin/Firebasefirestore/clothesstore.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GridView.count(
        crossAxisCount: 2,
        children: [
          buildCategoryItem(context, 'Clothes', 'assets/clothes.jpeg', FirestoreClothesPostscreen()),
          ...
          buildCategoryItem(context, 'Banners', 'assets/foods.jpeg', ImageUploadScreen()),
        ],
      ),
    );
  }
