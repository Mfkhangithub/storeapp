...
import 'package:store_app/View/Admin/AdminProducts/Category/Glocery/gloceryeditpage.dart';

class FirestoreGloceryPostscreen extends StatefulWidget {
  const FirestoreGloceryPostscreen({super.key});

  @override
  State<FirestoreGloceryPostscreen> createState() => _FirestorePostscreenState();
}

class _FirestorePostscreenState extends State<FirestoreGloceryPostscreen> {
  ...
  bool loading = false;
  final fireStore = FirebaseFirestore.instance.collection("glocerydata");
   File? _image;
  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(
      ...
      title: Text("Glocery Post", style: TextStyle(color: Colors.white),
      ),),
              ...
              TextButton(
                ...
                onPressed: () {
                  ...
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(builder: (context) => GloceryProScreen()), // Replace with your target screen
                  );
                },
              ),
            ],
