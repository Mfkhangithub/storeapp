...
class FirestorePostShoesscreen extends StatefulWidget {
  const FirestorePostShoesscreen({super.key});

  @override
  State<FirestorePostShoesscreen> createState() => _FirestorePostscreenState();
}

class _FirestorePostscreenState extends State<FirestorePostShoesscreen> {
  ...
  bool loading = false;
  final fireStore = FirebaseFirestore.instance.collection("shoesdata");
   File? _image;
  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(
      ...
      title: Text("Shoes Post", style: TextStyle(color: Colors.white),
      ),),
              ...
              TextButton(
                ...
                onPressed: () {
                  ...
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(builder: (context) => ShoesProScreen()), // Replace with your target screen
                  );
                },
              ),
            ],
