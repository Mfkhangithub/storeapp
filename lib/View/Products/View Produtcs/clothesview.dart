...
class ClothesProductView extends StatefulWidget {
  @override
  State<ClothesProductView> createState() => _ClothesProductViewState();
}

class _ClothesProductViewState extends State<ClothesProductView> {
